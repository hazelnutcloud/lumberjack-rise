...
contract LumberjackTimerTest is Test {
    ...
    function testTimerCapMechanism() public {
        ...
        for (uint i = 0; i < 5; i++) {
            ...
            Lumberjack.Move safeMove = nextBranch == uint8(Lumberjack.BranchSide.LEFT) 
                ? Lumberjack.Move.RIGHT 
                : Lumberjack.Move.LEFT;
    ...
    function testTimerLogicWithDifferentTimestamps() public {
        ...
        for (uint i = 0; i < waitTimes.length; i++) {
